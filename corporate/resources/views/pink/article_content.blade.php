 ...
 <div id="content-single" class="content group">
 	<div class="hentry hentry-post blog-big group ">
 		...
 		<div class="meta group">
 			...
 			<p class="comments"><span><a href="#comments" title="Comment on This is the title of the first article. Enjoy it.">{{ count($article->comments)?  count($article->comments) : '0' }} коментар/а</a></span></p>
 		</div>
 		<!-- post content -->
 	...
 	<div id="comments">
 		<h3 id="comments-title">
 			<span>{{ count($article->comments) }}</span> коментар/а    
 		</h3>
 		...
 		<div id="respond">
 			...
 			{{ csrf_field() }}
 				...
 				<p class="form-submit">
 					...
 					<input type="hidden" name="comment_parent" value="{{ $article->id}}">
