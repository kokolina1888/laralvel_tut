...
use App\Http\Requests\UploaNewFolderRequest;
...
class UploadController extends Controller
{
    ...
    public function createFolder(UploaNewFolderRequest $request)
    {
    ...
    public function deleteFolder(Request $request)
    {
        ...
        $error = $result ?: "An error occurred deleteing directory.";
        return redirect()->back()->withErrors([$error]);
