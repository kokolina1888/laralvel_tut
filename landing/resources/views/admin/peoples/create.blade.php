...
<div class="wrapper container-fluid">
	...
	@endif
	{!!Form::open(['method'=>'POST', 'class'=>'form-horizontal', 'action' => 'PeoplesController@store', 'files'=>true])!!}	
	...
	<div class="form-group">
		...
		<div class="col-xs-8">
			{!! Form::text('position', old('position'), ['class' => 'form-control','placeholder'=>'Enter position']) !!}
		</div>
	</div>
	<div class="form-group">
